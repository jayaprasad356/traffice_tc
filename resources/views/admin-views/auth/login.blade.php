                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        ...
                        <form class="" id="form-id" action="{{route('admin.auth.login')}}" method="post">
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    <h1 class="display-4"> {{translate('TS Traffic e-Challan')}}</h1>
                            ...
                            <div class="js-form-message form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" name="email" id="signinSrEmail"
                                       tabindex="1" placeholder="{{translate('email@address.com')}}" aria-label="text"
                 ...
                 {{--   @if(env('APP_MODE')=='demo')
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-10">
                                    <span>{{translate('name : admin@admin.com')}}</span><br>
