                    ...
                    <div class="card-body">
                        ...
                        <form id="form-id" action="{{route('branch.auth.login')}}" method="post">
                            ...
                            <div class="js-form-message form-group">
                                <label class="input-label" for="signinSrEmail">{{translate('Your username')}}</label>

                                <input type="f_name" class="form-control form-control-lg" name="f_name" id="f_name"
                                       tabindex="1" placeholder="{{translate('username')}}" aria-label="f_name"
                                       required data-msg="{{translate('Please enter a valid username.')}}">
                            </div>
                            <!-- End Form Group -->
