...
Route::get('admin/withdrawal/export-all', 'Admin\withdrawalController@exportAllWithdrawals')->name('admin.Withdrawal.export-all');
Route::get('admin/withdrawal/export-unverified', 'Admin\withdrawalController@exportUnverified')->name('admin.Withdrawal.export-unverified');
